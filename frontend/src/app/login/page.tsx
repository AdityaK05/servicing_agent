      ...
      <main className="flex flex-1 items-center justify-center p-6">
        <div className="w-full max-w-md space-y-8 rounded-card border border-brand-gold/20 bg-white p-8 shadow-card">
          <div className="text-center">
            <h2 className="text-h3 font-medium text-brand-green">Welcome back</h2>
            <p className="mt-2 text-body text-neutral-600">
              Sign in to manage your credit cards
            </p>
          </div>
          ...
          <form className="mt-8 space-y-6" action={login}>
            ...
            <button
              type="submit"
              className="w-full rounded-pill bg-brand-gold px-4 py-3 text-body-sm font-semibold text-white transition-colors hover:bg-brand-gold-600"
            >
              Sign In
            </button>
          </form>
